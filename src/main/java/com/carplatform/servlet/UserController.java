...
@Controller
// C1 - register/login/profile + HttpSession
public class UserController {

    private final AuthenticationService authService;

    // spring wires in the auth service
    ...
    // create buyer or seller account from the form
    ...
    @PostMapping("/login")
    // check username/password and start session
    ...
    @GetMapping("/profile")
    // open profile page for logged-in user
    ...
    @GetMapping("/")
    // root URL sends people to car browse
    public String home() { return "redirect:/cars"; }


    // turn error codes into friendly messages
