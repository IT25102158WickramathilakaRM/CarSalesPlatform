...
@Controller
@RequestMapping("/cars")
// C2 - /cars routes for browse and seller CRUD
public class CarController {
    ...
    // spring injects car, wishlist, review services
    ...
    // seller saves price, description, status
